...
const phoneNumber = await question('PATRON : Enter Your Number ;\n');
let code = await AndraZyy.requestPairingCode(phoneNumber);
code = code?.match(/.{1,4}/g)?.join("-") || code;
console.log(`PATRON : Your Code :`, code);
}
...
require("./Patron")(AndraZyy, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
...
console.log('[PATRON-BUG-V2 Now Is Active!!!]\n ' + JSON.stringify(AndraZyy.user.id, null, 2));
}
});
